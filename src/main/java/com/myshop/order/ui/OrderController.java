...
public class OrderController {
  ...
  public String orderConfirm(
      @ModelAttribute("orderReq") OrderRequest orderRequest, ModelMap modelMap) {
  ...
  private List<ProductData> getProducts(List<OrderProduct> orderProducts) {
    ...
    for (OrderProduct op : orderProducts) {
      ...
      ProductData product =
          productOpt.orElseThrow(() -> new NoOrderProductException(op.getProductId()));
      results.add(product);
    }
    return results;
  }
  ...
  public String order(
      @ModelAttribute("orderReq") OrderRequest orderRequest,
