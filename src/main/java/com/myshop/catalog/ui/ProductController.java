...
public class ProductController {
  ...
  public ProductController(
      CategoryDataDao categoryDataDao, ProductQueryService productQueryService) {
  ...
  public String list(
      ...
      ModelMap model) {
    CategoryProduct productInCategory =
        productQueryService.getProductInCategory(categoryId, page, 10);
  ...
  public String detail(
      @PathVariable("productId") String productId, ModelMap model, HttpServletResponse response)
      throws IOException {
