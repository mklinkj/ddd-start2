...
class ProductRepositoryIT {
  ...
  void save() {
    ...
    Product product =
        new Product(ProductId.of("PRD-01"), "제품-01", new Money(9000), "상세 내용", images);
    ...
    SqlRowSet rsImg =
        jdbcTemplate.queryForRowSet(
            "select * from image where product_id = ? order by list_idx", "PRD-01");
  ...
  void updateImages() {
    ...
    product.changeImages(
        List.of(new InternalImage("/path01.png"), new InternalImage("/path02.png")));
